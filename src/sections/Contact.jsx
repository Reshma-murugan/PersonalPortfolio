  ...
  return (
    <section id="contact" className="contact">
      <div className="container">
        ...
        <div ref={ref} className={`contact-content ${inView ? 'fade-in' : ''}`}>
          {/* Contact Information */}
          <div className="contact-info">
            <div className={`info-item animate-fadeIn`} style={{ animationDelay: '200ms' }}>
            ...
            <div className={`info-item animate-fadeIn`} style={{ animationDelay: '400ms' }}>
              <div className="info-icon">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="info-text">
                ...
                <p className="info-detail">Tamil Nadu, India</p>
              </div>
            </div>
